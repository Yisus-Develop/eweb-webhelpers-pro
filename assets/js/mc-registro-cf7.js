(function($){
  ...
  /**
   * COMENTADO PARA EVITAR CONFLICTOS CON EL DOSSIER Y LENTITUD
   * Esta redirección global afectaba a todos los formularios por igual.
   * Ahora cada formulario puede gestionar su propia lógica de éxito.
   */
  /*
